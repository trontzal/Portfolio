    ...
    <div class="dentroExperiencia">
        ...
        <div class="contenidosExperiacia">
            <div>
                ...
                <div>
                    <p class="parrafoExperiencia">Bootcamp fullstack desde lo básico con HTML, CSS y
                        JavaScript hasta a temas más complejos como vue, Python y MySQL, aplicando todo en
...
.contenidosExperiacia>div {
    margin-bottom: 2rem;
    border-left: solid rgb(255, 217, 0);
    padding-left: 0.5rem;
